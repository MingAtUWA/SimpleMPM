...
public:
	...
	inline size_t get_node_num(void) const { return node_num; }
	inline const Node *get_nodes(void) const { return nodes; }
	inline size_t get_elem_num(void) const { return elem_num; }
	inline const Element *get_elems(void) const { return elems; }
...
public: // for debug purpose
	...
	void dump_mesh_info(const char *dump_file_name, bool dump_bl);
