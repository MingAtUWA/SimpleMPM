#ifndef _TIMEHISTORY_PARTICLE_2D_ME_H_
#define _TIMEHISTORY_PARTICLE_2D_ME_H_
...
enum class Particle_2D_ME_Field : unsigned short int
{
	x   = 1,
	y   = 2,
	vol = 3,
...
/* ===========================================================
Class TimeHistory_Particle_2D_ME
   =========================================================== */
class TimeHistory_Particle_2D_ME : public TimeHistory
{
public:
	TimeHistory_Particle_2D_ME();
	~TimeHistory_Particle_2D_ME();
	
	int set_model_output(Model_R2D_ME_MPM_s *md,
		Particle_2D_ME_Field *fld_ids, size_t fld_num,
...
protected:
	typedef void(TimeHistory_Particle_2D_ME::* TimeHistoryFieldFunc)(void);
	struct ParticleInfo
	{
		size_t obj_id;
		Particle_2D_ME *pcl;
	...
	int add_particle(size_t obj_id, Particle_2D_ME *pcl);
	inline void set_field_num(size_t num) { fld_mem.reserve(num); }
	int add_field(Particle_2D_ME_Field fld);
