#ifndef _TIMEHISTORY_PARTICLE_S2D_CHM_MIX_ALLPCL_H_
#define _TIMEHISTORY_PARTICLE_S2D_CHM_MIX_ALLPCL_H_
...
/* ===========================================================
Class TimeHistory_Particle_S2D_CHM_Mix_AllPcl
   =========================================================== */
class TimeHistory_Particle_S2D_CHM_Mix_AllPcl : public TimeHistory
{
public:
	TimeHistory_Particle_S2D_CHM_Mix_AllPcl();
	~TimeHistory_Particle_S2D_CHM_Mix_AllPcl();
...
protected:
	...
	MemoryUtilities::ItemArray<Particle_S2D_CHM_Mix *> pcl_mem;

	typedef void(TimeHistory_Particle_S2D_CHM_Mix_AllPcl::* TimeHistoryFieldFunc)(void);
	struct FieldInfo
	{
