#ifndef _STEP_R2D_ME_MPM_BSPLINE_APIC_S_H_
#define _STEP_R2D_ME_MPM_BSPLINE_APIC_S_H_
...
class Step_R2D_ME_MPM_BSpline_APIC_s : public Step
{
protected:
...
public:
	...
	inline void set_model(Model_R2D_ME_MPM_BSpline_s *md)
	{
		Step::set_model(md);
		model = md;
	}
	// Restart version
	inline void set_prev_step(Step_R2D_ME_MPM_BSpline_APIC_s *prev_step)
	{
