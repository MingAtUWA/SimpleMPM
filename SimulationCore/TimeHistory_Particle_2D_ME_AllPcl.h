#ifndef _TIMEHISTORY_PARTICLE_2D_ME_ALLPCL_H_
...
/* ===========================================================
Class TimeHistory_Particle_2D_ME_AllPcl
   =========================================================== */
class TimeHistory_Particle_2D_ME_AllPcl : public TimeHistory
{
public:
	TimeHistory_Particle_2D_ME_AllPcl();
	~TimeHistory_Particle_2D_ME_AllPcl();
...
protected:
	...
	typedef void(TimeHistory_Particle_2D_ME_AllPcl::* TimeHistoryFieldFunc)(void);
	struct FieldInfo
	{
