...
Element_R2D_CHM_MPM *Model_R2D_CHM_MPM_s::find_in_which_element(double x, double y)
{
...
Element_R2D_CHM_MPM *Model_R2D_CHM_MPM_s::find_in_which_element(
	double x, double y, Element_R2D_CHM_MPM *elem)
{
	size_t elem_x_id, elem_y_id;
...
double Model_R2D_CHM_MPM_s::cal_characteristic_length(Element_R2D_CHM_MPM *elem)
{
...
void Model_R2D_CHM_MPM_s::cal_shape_function(Particle_2D_CHM *pcl)
{
